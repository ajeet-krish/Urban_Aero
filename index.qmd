...
We tested four urban archetypes. Each animation displays three panels: **Wind Speed (m/s)** with streamlines, **Vorticity (1/s)** (showing eddies), and **Smoke Concentration**.

*Note: Wind enters from the **Left (West)**. Pollutant is introduced along the Western boundary, advecting across the city.*
...
![Grid Comparison](assets/grid_sim.gif)

### 2. Staggered Layout
![Staggered Comparison](assets/staggered_sim.gif)

### 3. Canyon Layout
![Canyon Comparison](assets/canyon_sim.gif)

### 4. Courtyard Layout
![Courtyard Comparison](assets/courtyard_sim.gif)
